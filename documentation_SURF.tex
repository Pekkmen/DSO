            ...
            \section{Pontmegfeleltetés a képek között.}
                \begin{enumerate}
                    ...
                    \begin{enumerate}
                        ...
                        \end{itemize}
                        \item \textbf{Piramis-szerű skálatér felépítése} = A SIFT algoritmushoz hasonlóan egy piramis-szerű skálateret építünk. Jelentős különbség azonban, hogy a dobozszűrő alkalmazásának és az integrál kép készítésnek köszönhetően nem kell az egyes oktávokban a kép méretét csökkenteni, hanem elég a szűrő méretét növelni (ez gyorsabb számolást eredményez).
