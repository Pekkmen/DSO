        ...
        \section{Lencse által okozott torzítás eltávolítása.}
            ...
            \section{Pontmegfeleltetés a képek között.}
                \begin{enumerate}
                    ...
                    \item \textit{estrelpose(essentialMatrix,intrinsics,inlierPoints1,inlierPoints2)} = kiszámítja a két kamera relatív pozícióját az esszenciális mátrixból kinyert rotációs mátrix és transzlációs vektor alapján. Nem találtam meg, hogy pontosan hogyan teszi ezt :(
