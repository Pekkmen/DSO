...
\begin{document}
    ...
    \chapter{Forrás}
        \begin{itemize}
            ...
            \item \url{https://www.cs.cmu.edu/~16385/s17/Slides/11.4_Triangulation.pdf}
        \end{itemize}
\end{document}
